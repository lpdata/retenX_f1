...
st.set_page_config(
    page_title="Painel de Rematrículas",
    layout="wide",
    initial_sidebar_state="collapsed"
)

# --- FUNÇÃO DE CARREGAMENTO (COM CACHE AUTOMÁTICO) ---
...
# --- INTERFACE E BOTÃO DE ATUALIZAR ---
...
if not df.empty:
    ...
    cols_valores = ['REMATRICULADO', 'NÃO REMATRICULADO', 'EM TRANSFERENCIA']
    ...
    # Títulos em Negrito (para usar no subplot_titles)
    ...
    labels_legenda = ['Rematriculado', 'Não Rematriculado', 'Em Transferência']
    ...
    # Ajuste dos Títulos (Seu yshift=24)
    fig.update_annotations(
        font=dict(size=12, family="Arial"),
        yshift=24
    )

    # --- EXIBIÇÃO FINAL NO SITE ---
